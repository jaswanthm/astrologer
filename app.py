...
def getNumeroText(finalcount):
    if finalcount == 1:
        ...
        return "Your lucky number is " + str(finalcount) + " " + " and you are imaginative, expressive communicators and artists. You are tolerant, joyful, optimistic, inspiring, talented, jovial, youthful, dynamic ... the list goes on and on!"
    elif finalcount == 4:
        ...
        return "Your lucky number is " + str(finalcount) + " " + " and you are energetic, adventurous, daring and freedom-loving. You also tend to be versatile, flexible, adaptable, curious, social, sensual, quick-thinking, witty, courageous and worldly."
    elif finalcount == 6:
        ...
        return "Your lucky number is " + str(finalcount) + " " + " and you are authoritative, business-minded leaders. You value control and tend to be powerful, but are also balanced, materially detached, successful and realistic. They end up in management positions, are efficient, capable, street-smart and good judges of character."
    elif finalcount == 9:
